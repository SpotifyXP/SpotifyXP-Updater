...
public class Updater {
    ...
    public UpdateInfo updateAvailable() {
        try {
            GitHubAPI.Releases releases = InstanceManager.getGitHubAPI().getReleases();
    ...
    public String getChangelogForNewest() {
        JSONObject root = new JSONObject(InstanceManager.getGitHubAPI().makeRequestGet("https://api.github.com/repos/Werwolf2303/SpotifyXP/releases/latest"));
        GitHubAPI.Release release = InstanceManager.getGitHubAPI().getReleases().getLatest();
